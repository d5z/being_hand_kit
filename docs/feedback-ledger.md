...
| 项 | 反馈者 | 出处 | 状态 |
|---|---|---|---|
| Windows 中文 locale（6.10.0 修复后未测） | taojun | Noah 卷轴 GvaQuOtG《hand 6.10.0 Windows 中文 locale 验收参照》 | 15 行真值回填表（A1-E3）全待真机，结果回来逐项填，失败项进闭环（alice 685 承诺持续跟） |
